...
<form class="mx-5" method="post" enctype="multipart/form-data" action="{{route('brands.update',$brand)}}">
    ...
    <div class="form-group">
      ...
      name="name" id="name" value="{{old('name',$brand)}}">
    </div>
    @error('name')
    ...
    <div class="form-group">
        ...
        <input type="file" accept="image/*"
         class="form-control @error('image') is-invalid @enderror"  name="image" id="image" value="{{old('image',$brand)}}">
         <img width='100' src="{{url('storage/'.$brand->image)}}" alt="">
