...
class FireBaseController extends Controller
{
    ...
    // fcm_token لمستخدم معين
    //topic مجموعة من العملاء او رسائل جماعية
    public static function subscribeToTopic($registrationTokenOrTokens)
    {
        $factory = (new Factory)->withServiceAccount(__DIR__ . '/laravel10-firebas.json');
    ...
    public static function sendOneUser($notification, $deviceToken, $link, $user = null)
    {
        ...
        if ($deviceToken != null) {
            $factory = (new Factory)
                ->withServiceAccount(__DIR__ . '/laravel10-firebas.json');
            $messaging = $factory->createMessaging();
